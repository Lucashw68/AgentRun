...
<!-- agentrun:instructions:end -->'''
        ...
        self.assertIn('Do not create or modify project files solely to integrate AgentRun', upgraded)
        self.assertIn('An unsupported workload is not a missing-profile problem', upgraded)
        self.assertIn('or scope limitation, not an AgentRun rejection', upgraded)
